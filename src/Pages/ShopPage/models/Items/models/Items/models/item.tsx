...
const Item = (props: { imgSRC: string, name: string, price: number, typeName: string, brandName: string }) => {
    return <div style={{ width: '200px', border: 'solid 1px black', borderRadius: '10px', margin: '10px', padding: '10px' }}>
        ...
        />
        <p style={{ fontSize: '15px', fontWeight: 'lighter' }}>{props.brandName}</p>
        <p style={{ fontSize: '15px' }}>{props.typeName}</p>
        <p >{props.name}</p>
